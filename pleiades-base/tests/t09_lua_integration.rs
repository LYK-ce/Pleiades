...
use pleiades_base::lua::engine::LuaContext;
use pleiades_base::lua::capability_binding::register_caps;
use std::sync::Arc;
...
fn test_hello_script_loads_and_executes() {
    ...
    let bus = Arc::new(pleiades_base::event_bus::EventBus::New(4));
    pleiades_base::lua::capability_binding::register_logging_caps(&lua, bus)
