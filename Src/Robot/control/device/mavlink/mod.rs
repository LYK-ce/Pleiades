...
//!
//! `MavlinkDevice` — 封装 MAVLink 协议 + 串口 TX/RX，实现 `MotionDevice`。
//!
...
use constants::*;
use crate::robot::control::serial::port::spawn_port;
...
// ============================================================
// MotionDevice trait 实现（Task 22_4：统一运动接口）
// ============================================================
